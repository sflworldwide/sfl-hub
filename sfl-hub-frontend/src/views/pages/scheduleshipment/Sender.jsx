...
const Sender = ({
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        if (userData.length > 0) {
          ...
          setSenderErrors((prev) => ({ ...prev, zipCode: "", fromCity: "" }));
          return;
        }
        ...
        try {
          if (countrycode === "in") {
            ...
            const res = await axios.get(
              ...
              }&components=country:${countrycode}|postal_code:${zipCode}`
            );
  ...
  const {
    ...
    enabled: iszip === 0, // Only fetch cities when iszip === 0
  });
  ...
  const handleCityChange = (event, newValue) => {
    ...
    if (newValue) {
      setSenderErrors((prev) => ({ ...prev, fromCity: "" }));
    }
    else{
      setSenderErrors((prev) => ({ ...prev, fromCity: "City is required" }));
    }
  };
      ...
      <form onSubmit={onSubmit}>
        ...
        <Box sx={rowStyle}>
          <TextField
            ...
            value={zipCode}
            placeholder={
              iszip === 0 || Giszip === 1 ? "Not required" : undefined
            }
          ...
          {/* City field - Conditional rendering based on iszip */}
          {iszip === 0 ? (
            // Dropdown for city selection when iszip === 0
            <Autocomplete
              freeSolo
              disablePortal
              options={cities || []}
            ...
            // Regular text field when iszip !== 0
            <TextField
              label="From City"
              value={fromCity}
            ...
            <PhoneInput
              ...
              onChange={(phone, countryData) => {
                ...
                if (
                  ...
                  console.log(
                    "Clearing phone2: Input is empty or only dial code"
                  );
                  setPhone2("");
                  setoldphone2("");
              ...
              onBlur={() => {
                ...
                const trimmedPhone = phone2
                  ? phone2.replace(dialCode, "").trim()
                  : "";
                if (
                  !phone2 ||
                  phone2 === dialCode ||
                  ...
                  console.log(
                    "onBlur: Clearing phone2 as it's empty or only dial code"
                  );
                  setPhone2("");
                  setoldphone2("");
                  setSenderErrors((prev) => ({ ...prev, phone2: "" }));
        ...
        <Box sx={rowStyle}>
          <FormControl fullWidth sx={fieldStyle} className="small-textfield">
            ...
            <Select
              ...
              startAdornment={
                <LocalShippingIcon sx={{ color: "action.active", mr: 1 }} />
              }
              error={!!senderErrors.needsPickup}
            >
              <MenuItem value="No - I Will Drop Off My Package">
                No - I Will Drop Off My Package
              </MenuItem>
              <MenuItem value="Yes - I Need Pickup Service">
          ...
          {needsPickup === "Yes - I Need Pickup Service" ? (
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <CalendarTodayIcon sx={{ color: "red", mr: 1 }} />
                ),
              }}
              inputProps={{
                min: today,
