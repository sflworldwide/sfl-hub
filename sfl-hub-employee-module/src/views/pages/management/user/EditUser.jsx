...
const EditUser = () => {
  ...
  const [formData, setFormData] = useState(() => {
    ...
    return user
      ? {
          ...
          userStatus:
            user.status === "Active" || user.status === "Enable"
              ? "Enable"
              : "Disable",
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await axios.post(
        `${api.BackendURL}/locations/getFedexCityList`,
        {
        ...
        try {
          if (formData.country === "in") {
            ...
            const res = await axios.get(
              ...
              }&components=country:${formData.country}|postal_code:${
                formData.zip
              }`
            );
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        personId: personID,
        userdetailid: "0ed83f7c-38c8-47dd-b963-e57354f6fed3",
        ...
        paperSizePreview: formData.paperSizePreview,
          ...
          >
            ...
            <FormControl fullWidth className="custom-textfield">
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    ...
                    InputProps={{
                      ...params.InputProps,
                      startAdornment: (
                        <LocationCityIcon sx={{ color: "grey", mr: 1 }} />
                      ),
                      endAdornment: (
                        <>
                ...
                noOptionsText={
                  isCitiesError ? "Error loading cities" : "No cities found"
                }
              />
            </FormControl>
            <TextField
            ...
            <FormControl fullWidth className="custom-textfield">
              ...
              <Select
                ...
                notched
              >
                <MenuItem value="4 x 6" sx={{ fontSize: "11px" }}>
                  4 x 6
                </MenuItem>
                <MenuItem value="4 x 6.75" sx={{ fontSize: "11px" }}>
                  4 x 6.75
                </MenuItem>
                <MenuItem value="4 x 8" sx={{ fontSize: "11px" }}>
                  4 x 8
                </MenuItem>
                <MenuItem value="4 x 9" sx={{ fontSize: "11px" }}>
                  4 x 9
                </MenuItem>
                <MenuItem value="8.5 x 11" sx={{ fontSize: "11px" }}>
                  8.5 x 11
                </MenuItem>
              </Select>
            </FormControl>
            ...
            <FormControl fullWidth className="custom-textfield">
              ...
              <Select
                ...
                notched
              >
                <MenuItem value="Enable" sx={{ fontSize: "11px" }}>
                  Enable
                </MenuItem>
                <MenuItem value="Disable" sx={{ fontSize: "11px" }}>
                  Disable
                </MenuItem>
              </Select>
            </FormControl>
            <FormControl fullWidth className="custom-textfield">
              ...
              <Select
                ...
                notched
              >
                <MenuItem value="Employee" sx={{ fontSize: "11px" }}>
                  Employee
                </MenuItem>
                <MenuItem value="Customer" sx={{ fontSize: "11px" }}>
                  Customer
                </MenuItem>
                <MenuItem value="Contractor" sx={{ fontSize: "11px" }}>
                  Contractor
                </MenuItem>
              </Select>
            </FormControl>
