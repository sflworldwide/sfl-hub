...
const Myshipmentnew = ({ setEdit }) => {
  ...
  // Check if the word "commodity" is present in the message
  const trimmedMessage = rawMessage.toLowerCase().includes("commodity")
    ? "The commodity description is vague and requires clarification."
    : rawMessage;

  toast.error(trimmedMessage, { duration: 5000 });

  console.error("Error handling FedEx operations:", trimmedMessage);
}
  };
